...
- **Multi-Stage Builds:** 
  - We employ simple Docker constructs like [multi-stage builds](https://docs.docker.com/build/building/multi-stage/) to optimize our image size.

- **[No-hoisting](https://classic.yarnpkg.com/blog/2018/02/15/nohoist/) and Symlinking:**
  ...
  - selectively copying only the `node_modules` generated by [non-hoisted workspaces](https://classic.yarnpkg.com/blog/2018/02/15/nohoist/). 
